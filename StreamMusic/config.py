...
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "DsC_Chat")
BG_IMAGE = getenv("BG_IMAGE", "https://telegra.ph/file/72fff0e6dd000c7e17838.jpg")
admins = {}
...
SOURCE_CODE = getenv("SOURCE_CODE", "github.com/DumiduSathsara/Stream-Music")
